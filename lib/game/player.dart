...
class Player extends SpriteComponent
  ...
  void calculateAngle(TapDownDetails details) {
    var x = details.globalPosition.dx; // opposite
    var y = details.globalPosition.dy; // adjacent
    this.angle = atan2(x, y); // TOA - Opposite/Adjacent
  }
